 ...
 * <p>
 * To write a DAO, subclass and parameterize this class with your 
 * persistent class. Of course, assuming that you have a traditional 
 * 1:1 appraoch for Entity:DAO design.
 * <p>
 * You have to inject the <tt>Class</tt> object of the persistent 
 * class and a current Hibernate <tt>Session</tt> to construct a DAO.
 *
